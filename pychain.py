...
sender = str(st.text_area("Enter Sender address:"))

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver = str(st.text_area("Enter receiver address:"))


# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount = float(st.text_area("Enter amount for the transaction:"))
